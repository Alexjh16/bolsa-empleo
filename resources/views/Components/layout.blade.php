    ...
    <nav class="bg-gray-800">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="size-11" src="https://images-platform.99static.com//xjMAot8gseExfFvALMsP1Ukov1Y=/186x177:777x768/fit-in/500x500/99designs-contests-attachments/79/79173/attachment_79173468" alt="Your Company">
            </div>
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          ...
          <x-nav-link href="/about">Jobs</x-nav-link>
          <x-nav-link href="/contact">Contact</x-nav-link>
        </div>
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div class="shrink-0">
              <img class="size-10 rounded-full" src="https://refactoring.guru/images/content-public/logos/logo-new.png?" alt="">
            </div>
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Alexander Liskov</div>
              <div class="text-sm font-medium text-gray-400">alexxLiskov@example.com</div>
            </div>
