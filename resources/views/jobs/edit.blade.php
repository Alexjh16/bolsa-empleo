<x-layout>
    ...
    <form method="POST" action="/jobs/{{ $job->id}}">
        ...
        <div class="flex gap-x-6 items-center">
            <a href="{{ route('jobs.show', $job->id) }}" type="button" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
            <div>
      ...
      <form method="POST"  id="delete-form" action="{{ route('jobs.destroy', $job->id) }}" class="hidden">
        @csrf
        @method('DELETE');
      </form>
</x-layout>
