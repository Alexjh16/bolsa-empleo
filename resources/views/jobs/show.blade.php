                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2" x-data="{ saved: false }">
                                    <button @click="saved = !saved" class="flex items-center text-gray-500 hover:text-primary">
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
                        <div class="p-6">
                            ...
                            <div class="prose max-w-none text-gray-600">
                                <p class="mb-4">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla, harum eveniet? Amet, laudantium perspiciatis ipsam assumenda, cumque provident molestiae mollitia rerum necessitatibus blanditiis architecto aliquam maxime quo facere deleniti modi!
                                </p>
                                <p class="mb-4">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla, harum eveniet? Amet, laudantium perspiciatis ipsam assumenda, cumque provident molestiae mollitia rerum necessitatibus blanditiis architecto aliquam maxime quo facere deleniti modi!
                                </p>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start">
                                    <svg class="h-6 w-6 text-primary mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="p-6">
                            ...
                            <ol class="relative border-l border-gray-200 ml-3 space-y-6">
                                <li class="mb-6 ml-6">
                                    ...
                                    <h3 class="flex items-center text-lg font-semibold text-gray-900">Revisión de CV y portafolio</h3>
                                    <p class="mt-1 text-gray-600">Evaluaremos tu experiencia, habilidades y proyectos previos.</p>
                                </li>
                                <li class="mb-6 ml-6">
                                    <span class="absolute flex items-center justify-center w-8 h-8 bg-primary rounded-full -left-4 ring-4 ring-white">
                                        <span class="text-white font-bold">2</span>
                                    </span>
                                    <h3 class="flex items-center text-lg font-semibold text-gray-900">Entrevista técnica inicial</h3>
                                    <p class="mt-1 text-gray-600">Conversación con nuestro equipo técnico para evaluar tus conocimientos y experiencia.</p>
                                </li>
                                <li class="mb-6 ml-6">
                                    <span class="absolute flex items-center justify-center w-8 h-8 bg-primary rounded-full -left-4 ring-4 ring-white">
                                        <span class="text-white font-bold">3</span>
                                    </span>
                                    <h3 class="flex items-center text-lg font-semibold text-gray-900">Prueba técnica</h3>
                                    <p class="mt-1 text-gray-600">Realizarás un ejercicio práctico para demostrar tus habilidades de desarrollo frontend.</p>
                                </li>
                                <li class="ml-6">
                                    <span class="absolute flex items-center justify-center w-8 h-8 bg-primary rounded-full -left-4 ring-4 ring-white">
                                        <span class="text-white font-bold">4</span>
                                    </span>
                                    <h3 class="flex items-center text-lg font-semibold text-gray-900">Entrevista final</h3>
                                    <p class="mt-1 text-gray-600">Conocerás a nuestro equipo directivo y discutiremos aspectos culturales y expectativas.</p>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-4 mt-8 lg:mt-0">
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-8 sticky top-4">
                        <div class="p-6">
                            ...
                            <div class="mt-6 space-y-4">
                                <button class="w-full bg-primary hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded">
                                    Postularme ahora
                                </button>
                                <button class="w-full bg-white border border-primary text-primary hover:bg-indigo-50 font-bold py-3 px-4 rounded flex items-center justify-center">
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi? Voluptatem corrupti harum sunt vel in odit libero optio pariatur, mollitia repellat? Soluta, facere consectetur? Quidem voluptates expedita soluta nobis!
                            </p>
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <a href="#" class="block p-4 border border-gray-200 rounded-lg hover:border-primary hover:bg-gray-50">
                            ...
                            <a href="#" class="block mt-4 text-center text-primary hover:text-indigo-700 font-medium">
